...
if [ ! -f "$ENV_FILE" ]; then
    ...
    echo "Убедитесь, что скрипт запускается из директории, где лежит папка signaling_cpp,"
...
# Конфигурация
IMAGE_NAME="lunaricorn_signaling_cpp:latest"
CONTAINER_NAME="lunaricorn-signaling-dev"
